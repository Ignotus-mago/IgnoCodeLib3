...
public class Permutator {
	...
	/**
	 * Steps to the next permutation of the permutation array, returns false if the 
	 * last permutation has been reached. The next permutation is the one that would 
	 * appear next in a sorted list of all permutations, where the sorting function
	 * orders in ascending order. This is an implementation of an algorithm described by 
